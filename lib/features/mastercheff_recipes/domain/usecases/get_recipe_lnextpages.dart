...
class GetRecipesNextPages implements UseCase<List<RecipeModel>, ParamsRecipesWithPag> {
  final MSRecipesRepository _repository;

  GetRecipesNextPages(this._repository);
...
class ParamsRecipesWithPag extends Equatable {
  ...
  ParamsRecipesWithPag({required this.pageNumber});
