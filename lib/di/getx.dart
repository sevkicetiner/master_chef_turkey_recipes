...
Future<void> init() async {
  ...
  getInstance.registerLazySingleton(() => Repository(getInstance<RecipesRemoteDatasource>()));
  getInstance.registerLazySingleton(() => RecipesRemoteDatasource());
  getInstance.registerLazySingleton<MSRecipesRepository>(() => Repository(getInstance<RecipesRemoteDatasource>()));
}
